...
# data in excel sheet is normalized between (-1,1) so I scaled too (0.5 - 1) for Faust
    ...
    osc_target1 = "/MultichannelDataGranulator/Alpha/GainL" # osc target too UI element
    osc_target2 = "/MultichannelDataGranulator/Alpha/GainR"
    osc_target3 = "/MultichannelDataGranulator/Beta/GainL"
    osc_target4 = "/MultichannelDataGranulator/Beta/GainR"
